...
const String HOMEPAGE_TITLE = 'Homepage';

const String LOGIN_PAGE_TITLE = 'Login';
const String LOGIN_PAGE_LOGIN_BUTTON_TEXT = 'Login';
const String LOGIN_PAGE_SIGNIN_BUTTON_TEXT = 'Sign in';
const String LOGIN_PAGE_HINT_EMAIL = 'Insert your email';
const String LOGIN_PAGE_HINT_PASSWORD = 'Insert your password';
const String LOGIN_PAGE_UPPER_TEXT = 'Log into your account';

const String SIGNIN_PAGE_TITLE = 'Sign in';
const String SIGNIN_PAGE_EMAIL = 'Insert your email';
